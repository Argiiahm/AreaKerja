...
@section('content')
    <section class="pt-40 mx-10">
        ...
        <div class=" mx-auto bg-white p-6">
            ...
            <form class="space-y-4" action="/update/pendidikan/{{ $Data->id }}" method="POST">
                @csrf
                @method('PUT')
                <div>
                ...
                <div>
                    <label for="asal_pendidikan" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Asal
                        Pendidikan</label>
