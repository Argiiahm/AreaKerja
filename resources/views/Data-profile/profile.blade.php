                ...
                <div class="container mx-auto p-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="bg-white p-6 space-y-5">
                            <h2 class="text-lg font-bold text-gray-800 border-b-2 border-orange-500 pb-2 mb-4">Data Diri
                            </h2>
                                ...
                                @if (Auth::user()->pelamars->alamat_pelamars->count() >= 1)
                                    <a href="/alamat">
                                        <label class="block text-sm font-semibold text-gray-800 mb-1">Alamat <span
                                                class="text-red-500">*</span></label>
                                        <div
                                            class="w-full bg-orange-500 text-white border border-orange-500 rounded-md p-2">
                            ...
                            @else
                                <div class="mb-4">
                                    <label class="block text-sm font-semibold text-gray-800 mb-1">Organisasi</label>
                                    <button data-modal-target="add_organisasi-modal"
                                        data-modal-toggle="add_organisasi-modal" type="button"
                            ...
                            @if (Auth::user()->pelamars->riwayat_pendidikan)
                                <div>
                                    ...
                                    <div class="flex gap-2 w-full">
                                        <div class="bg-gray-100 rounded-lg w-full">
                                            @foreach (Auth::user()->pelamars->riwayat_pendidikan as $r)
                        ...
                        <div class="bg-white  p-6">
                            <h2 class="text-lg font-bold text-gray-800 border-b-2 border-orange-500 pb-2 mb-4">Informasi
                                Akun
                            </h2>
                                ...
                                <div>
                                    ...
                                    <div class="text-sm text-orangea-500 mt-3 space-y-5">
                                        <p><i
                                            ...
                                            menjadi kandidat Areakerja, CV anda akan otomatis terunggah ke etalase
                                            perusahaan
                                        </p>
                                        <p><i
