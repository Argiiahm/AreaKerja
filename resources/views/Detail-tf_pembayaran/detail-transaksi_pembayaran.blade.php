    ...
    <div class="container max-w-4xl mx-auto bg-white shadow-md rounded-2xl mt-32 p-8 border border-gray-200">
            ...
            <div class="flex justify-center items-start">
                <div class="border border-gray-200 rounded-xl shadow-sm p-6 text-center w-full mx-10">
                    @if ($Bank->nama_bank === 'QRIS')
                        ...
                        <div class="text-left">
                            <p class="text-lg font-bold text-gray-800">{{ $Data->sumber_dana }}</p>
                            <span id="noRek">NMID : {{ $Bank->no_rek }}</span>
                        </div>
                        <div class="flex justify-center my-1">
                            <img class="w-52" src="{{ asset('topup_icon/qrcode.png') }}" alt="">
                        </div>
                    @else
                        <img src="{{ asset($Bank->logo_img) }}" alt="BCA" class="w-24 mx-auto mb-3">
        ...
        <div class="mt-8 overflow-x-auto px-4">
            ...
            <div class="mt-4 space-y-2 text-sm px-2">
                ...
                <p class="flex justify-between font-bold border-t pt-2 border-gray-200"><span>Total Tagihan</span>
        ...
        <div class="mt-8 px-4">
            <form
                action="{{ isset($isPreview) && $isPreview ? '/dashboard/perusahaan/topup/final-upload' : '/upload/bukti/pembayaran/' . $Data->id }}"
            ...
            @if ($Bank->nama_bank === 'QRIS')
                <div class="mx-20 my-5">
                    <ul class="list-decimal">
                        <li>Pilih pembayaran menggunakan QRIS</li>
                        <li>Buka aplikasi E-Wallet anda (ShoppePay, Gopay, Dana, dll.)</li>
                        <li>Pilih opsi pembayaran menggunakan kode / “scan kode”</li>
                        <li>Arahkan kamera scan anda ke kode pembayaran yang tertera di halaman web</li>
                        <li>Masukan PIN sandi dan akan muncul status pembayaran anda</li>
                    </ul>
                </div>
            @else
                <div class="divide-y border-t border-b border-gray-200">
                    ...
                    <button
                        class="w-full flex justify-bet  ween items-center py-3 text-left font-medium text-gray-700 hover:bg-gray-50">
