...
@section('content')
  ...
  <!-- Hero Section -->
  <section class="bg-white px-6 py-12 flex flex-col md:flex-row items-center justify-between">
  ...
  <section class="px-6 py-12 flex justify-center">
    <div class="border-2 border-orange-500 rounded-lg p-8 max-w-3xl flex flex-col md:flex-row items-center space-y-6 md:space-y-0 md:space-x-8">
      <div class="md:w-1/2 space-y-4">
