...
@section('content')
    <div class="min-h-[80vh] flex items-center h-screen justify-center py-20 px-4">
        <div class="max-w-md w-full text-center">
            ...
            {{-- Title & Message --}}
            <h1 class="text-3xl font-black text-slate-800 mb-3 tracking-tight">Top Up Berhasil!</h1>
            <p class="text-slate-500 mb-8 leading-relaxed">
                Bukti pembayaran Anda telah berhasil diupload dan saat ini sedang menunggu konfirmasi dari pihak admin.
                Harap tunggu beberapa saat hingga koin masuk ke saldo Anda.
            </p>
