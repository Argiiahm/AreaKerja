...
@section('admin-content')
    <div class="p-6" x-data="eventSearch()">
        <div class="block lg:flex justify-between items-center mb-4">
            <a href="/dashboard/superadmin/event/add" class="bg-gray-700 border text-white px-4 py-2 rounded-md">Buat
                Event</a>
            <div class="flex items-center space-x-2 mt-0 lg:mt-0 md:mt">
                <input type="text" placeholder="Cari event" x-model="search"
                    ...
                    <tbody class="text-center">
                        @foreach ($Data as $d)
                            <tr class="px-6 py-4 whitespace-no-wrap border-gray-500 border-b hover:bg-gray-50 transition-all"
                                ...
                                <td class="py-4 whitespace-no-wrap text-white font-bold border-gray-500 text-sm leading-5">
