    ...
    <div class="p-6 mt-8 px-5 lg:px-20 md:px-5 border-2">
        ...
        <div class="flex items-center gap-4 mb-6">
            <div class="flex items-center gap-4">
                <img src="https://plus.unsplash.com/premium_photo-1689568126014-06fea9d5d341?fm=jpg&q=60&w=3000&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MXx8cHJvZmlsZXxlbnwwfHwwfHx8MA%3D%3D" alt="Profile Picture" class="w-20 h-20 rounded-full object-cover border">
                <div>
            ...
            <div class="flex flex-col gap-2">
                <button type="button"
                    class="flex items-center gap-1 bg-gray-600 hover:bg-gray-700 text-white px-4 py-2 rounded-md text-sm">
                ...
                <button type="button"
                    class="flex items-center gap-1 border border-gray-400 text-gray-600 hover:bg-gray-100 px-4 py-2 rounded-md text-sm">
                    <svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4" fill="none" viewBox="0 0 24 24"
                        stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
