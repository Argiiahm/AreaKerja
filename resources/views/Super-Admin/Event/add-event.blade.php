...
<div class="p-8 bg-[#F9FAFB] min-h-screen">
    <div class="max-w-5xl mx-auto">
        ...
        <form id="eventForm" action="/dashboard/superadmin/event/store" method="POST" enctype="multipart/form-data" class="space-y-6">
            @csrf
                ...
                <div class="lg:col-span-2 space-y-6">
                    ...
                    <div class="bg-white border border-gray-200 rounded-2xl p-6 shadow-sm space-y-6">
                        <div class="space-y-2 flex-1">
                            ...
                            <input type="text" name="link_form" placeholder="Masukkan url link pendaftaran..."
