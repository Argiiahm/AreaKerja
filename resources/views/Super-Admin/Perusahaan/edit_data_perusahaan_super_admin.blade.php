    ...
    <div class="mx-auto mt-10">
        <div class="p-8">
            ...
            <div class="flex items-center gap-2 mb-5">
                <img id="previewImage"
                    src="{{ $Data->img_profile ? asset('storage/' . $Data->img_profile) : 'https://static.vecteezy.com/system/resources/thumbnails/005/544/718/small_2x/profile-icon-design-free-vector.jpg' }}"
                    ...
                    <div class="grid md:grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="text" class="w-full border border-gray-200 rounded-md px-3 py-2 text-sm"
                                disabled placeholder="User ID" value="{{ $Data->id }}">
                        </div>
                        <div>
                            <label class="block text-sm mb-1">Email *</label>
                            <input type="email" name="email"
                                class="w-full border border-gray-200 rounded-md px-3 py-2 text-sm" placeholder="Email"
                                value="{{ $Data->users->email }}">
                        </div>
                        <div>
                            <label class="block text-sm mb-1">Username *</label>
                            <input type="text" name="username"
                                class="w-full border border-gray-200 rounded-md px-3 py-2 text-sm" placeholder="Username"
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <input name="legalitas" type="text"
                                class="w-full border border-gray-200 rounded-md px-3 py-2 text-sm" placeholder="Legalitas"
