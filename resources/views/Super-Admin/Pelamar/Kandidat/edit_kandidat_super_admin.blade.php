...
@section('super_admin-content')
        ...
        <div class="flex items-center gap-2 mb-5">
            ...
            <div class="flex gap-2">
                <label
                    ...
                    <input type="file" name="img_profile" id="foto" class="hidden" accept="image/*" form="kandidatForm">
                </label>
    ...
    <form id="kandidatForm" action="/edit/kandidat/{{ $Data->id }}" method="POST" class="space-y-4"
        enctype="multipart/form-data">
        @csrf
        @method('PUT')
        <div>
            <label class="block text-sm mb-1">Pelamar ID *</label>
            <input type="text" name="" disabled value="{{ $Data->id }}" class="w-full border rounded-md px-3 py-2">
            <input type="hidden" name="role" value="{{ $Data->users->role }}">
        </div>

        <div>
            <label class="block text-sm mb-1">Email *</label>
            <input type="email" name="email" value="{{ $Data->users->email }}" class="w-full border rounded-md px-3 py-2">
        </div>
        ...
        <div>
            ...
            <div class="bg-gray-100 p-3 rounded-md">
                {{ $Data->alamat_pelamars()->latest()->first()->detail ?? 'Data Belum Di Isi' }}
            </div>
        </div>
        ...
        @else
            <div class="mb-4">
                <label class="block text-sm font-semibold text-gray-800 mb-1">Riwayat
                    Pendidikan</label>
                <button type="button" data-modal-target="add_riwayat_pendidikan" data-modal-toggle="add_riwayat_pendidikan"
                    class="flex items-center justify-between border border-orange-500 rounded-md w-full px-4 py-3 text-orange-500 font-semibold">
        ...
        @else
            <div class="mb-4">
                <label class="block text-sm font-semibold text-gray-800 mb-1">Pengalaman Kerja</label>
                <button type="button" data-modal-target="add_pengalaman-modal" data-modal-toggle="add_pengalaman-modal"
                    class="flex items-center justify-between border border-orange-500 rounded-md w-full px-4 py-3 text-orange-500 font-semibold">
        ...
        @else
            <div class="mb-4">
                <label class="block text-sm font-semibold text-gray-800 mb-1">Skill <span class="text-red-500">*</span></label>
        ...
        <div class="relative p-4 w-full max-w-md max-h-full">
            <div class="relative bg-white rounded-lg shadow-sm dark:bg-gray-700">
                ...
                <div class="p-4 w-full md:p-5">
                    ...
                    <button data-modal-target="add_skill" data-modal-toggle="add_skill" data-modal-hide="detail_skill"
                        type="button"
                        class="w-full text-white border mt-5 border-orange-500 font-medium rounded-lg text-sm px-5 py-2.5 text-center">
                        <div class="flex justify-between items-center text-orange-500">
                            <span>Tambahkan Skill</span>
