...
@section('super_admin-content')
    <div class="w-full  rounded-none p-8">
        <div class="pl-12">
            ...
            <div class="flex justify-center gap-4 mt-8">
                <a href="/dashboard/superadmin/pelamar/edit/kandidat"
                    class="px-6 py-2 bg-cyan-500 text-white rounded-md shadow hover:bg-cyan-600">
                    Edit
                </a>
                <a href="#" class="px-6 py-2 bg-green-500 text-white rounded-md shadow hover:bg-green-600">
                    Unduh
                </a>
                <a href="#" class="px-6 py-2 bg-red-500 text-white rounded-md shadow hover:bg-red-600">
                    Hapus
                </a>
            </div>
        </div>
                ...
                <div class="col-span-2 space-y-8">
                    <div>
                        ...
                        <div class="space-y-4 text-sm text-gray-700">
                            ...
                            <div>
                                <p class="font-semibold">Front End Developer <span class="text-gray-500">(2022–2023)</span>
                                </p>
