...
@section('super_admin-content')
    <div class="p-8">
        <form id="formNonKandidat" action="/dashboard/superadmin/pelamar/create/non_kandidat" method="POST"
            ...
            <input type="text" name="kategori" value="pelamar" hidden>
            ...
            <button type="submit" class="bg-orange-400 px-6 text-white rounded-md py-2 float-end cursor-pointer">Simpan</button>
        </form>
