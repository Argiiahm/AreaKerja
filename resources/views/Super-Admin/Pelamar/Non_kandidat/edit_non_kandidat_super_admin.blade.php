    ...
    @section('super_admin-content')
        <div class="mx-auto bg-white shadow-md rounded-xl p-6">
            ...
            <form id="kandidatForm" action="/edit/nonkandidat/{{ $Data->id }}" method="POST" class="space-y-4" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div>
                ...
                <div>
                    ...
                    <div class="bg-gray-100 p-3 rounded-md">
                        {{ $Data->alamat_pelamars()->latest()->first()->detail ?? 'Data Belum Ada!' }}</div>
                </div>
