    ...
    <div class="rounded-lg border border-gray-300 p-8 w-full">
        ...
        <form class="space-y-6">
            ...
            <div class="flex justify-center gap-4 pt-4">
                <button type="submit"
                    class="bg-green-500 hover:bg-green-600 text-white font-medium py-2 px-8 rounded-md transition duration-200">
                    Hapus
                </button>
                <button type="button"
                    class="bg-red-500 hover:bg-red-600 text-white font-medium py-2 px-8 rounded-md transition duration-200">
                    Batal
                </button>
            </div>
        </form>
