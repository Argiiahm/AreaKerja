    ...
    <form action="/dashboard/superadmin" method="POST" enctype="multipart/form-data" class="space-y-10">
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
            <div class="bg-orange-500 px-6 py-4 flex items-center gap-3">
                ...
                <h2 class="text-white font-bold text-lg">Social Media Links</h2>
            </div>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
            <div class="bg-orange-500 px-6 py-4 flex items-center gap-3">
                ...
                <h2 class="text-white font-bold text-lg">Image Header Management</h2>
            </div>
            ...
            <div class="p-6 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div class="flex flex-col space-y-3 bg-white p-4 rounded-xl border border-gray-100 shadow-sm hover:shadow-md transition-shadow">
                    <label class="font-bold text-gray-700 border-l-4 border-orange-500 pl-3">{{ $label }}</label>

                    {{-- Image Preview Container --}}
                    <div class="relative group h-32 w-full bg-gray-100 rounded-lg overflow-hidden border border-gray-200">
        ...
        <div class="flex justify-end pt-4">
            <button type="submit" class="group flex items-center gap-2 px-8 py-3 bg-orange-500 hover:bg-orange-600 text-white font-bold rounded-xl shadow-lg shadow-orange-200 transition-all active:scale-95">
...
{{-- Modern Modal --}}
<div id="imgModal" class="fixed inset-0 bg-gray-900/90 backdrop-blur-sm hidden z-[100] p-4 flex items-center justify-center transition-all duration-300">
    <div class="relative max-w-5xl w-full animate-in zoom-in duration-300">
        <button onclick="closeModal()" class="absolute -top-12 right-0 text-white hover:text-orange-400 transition-colors">
