...
@section('super_admin-content')
    <div class="mx-auto p-6 mt-8 border-2 border-gray-200 rounded-lg px-5 lg:px-20 md:px-5 bg-white shadow-md space-y-6">
        <h2 class="text-2xl font-bold text-gray-800 border-b border-gray-200 pb-3">Edit Profile</h2>

        <div class="flex items-center gap-5">
            @if (Auth::user()->superadmins->img_profile)
                <img src="{{ asset('storage/' . Auth::user()->superadmins->img_profile) }}" alt="Profile Picture"
            ...
            @else
                <img src="https://ui-avatars.com/api/?name={{ urlencode(Auth::user()->username) }}&background=random&color=fff&size=128"
                    alt="Profile Picture" class="w-24 h-24 rounded-full object-cover border-2 border-gray-300 shadow">
            @endif
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
                ...
                <input type="email" readonly
                    class="w-full border border-gray-200 rounded-md p-2.5 focus:outline-none focus:ring-2 focus:ring-gray-300 bg-gray-50"
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div>
                ...
                <select disabled class="w-full border border-gray-200 rounded-md p-2.5 bg-gray-50">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
                ...
                <input type="text" readonly class="w-full border border-gray-200 rounded-md p-2.5 bg-gray-50"
