...
<body>
        ...
        <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
            ...
            <div class="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-sticky">
                <ul class="flex flex-col p-4 md:p-0 mt-4 font-medium md:flex-row md:mt-0 md:border-0 ">
                    <li>
                        <a href="/" class="block {{ Request()->is('/') ? 'opacity-30' : '' }} py-2 px-3 text-[#fa6601] font-semibold">Beranda</a>
                    </li>
                    <li>
                        <a href="#" class="block py-2 px-3 text-[#fa6601] font-semibold">Talent Hunter</a>
                    </li>
                    <li>
                        <a href="/tipskerja" class="block  {{ Request()->is('tipskerja') ? 'opacity-30' : '' }} py-2 px-3 text-[#fa6601] font-semibold">Tips Kerja</a>
                    </li>
                    <li>
                        <a href="/daftarkandidat" class="block {{ Request()->is('daftarkandidat') ? 'opacity-30' : '' }} py-2 px-3 text-[#fa6601] font-semibold">Daftar Kandidat</a>
                    </li>
                    <li>
    ...
    <footer class="bg-orange-500  text-white py-10 mt-32">
        <div class="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-3 gap-8">
            <div>
                <div class="flex items-center gap-2">
                    <img class="w-20 h-20" src="{{ asset('image/logo_area_kerja_putih.png') }}" alt="Logo" class="h-10">
                </div>
