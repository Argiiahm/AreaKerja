            ...
            <div class="w-full max-w-md px-6">
                ...
                <div class="grid grid-cols-5 text-center text-sm mb-6">
                    <div>
                        ...
                        <p class="text-orange-500">Karakter</p>
                    </div>
                    <div>
                        <p class="text-black font-semibold">AA</p>
                        <p class="text-orange-500">Huruf Besar</p>
                    </div>
                    <div>
                        <p class="text-black font-semibold">aa</p>
                        <p class="text-orange-500">Huruf Kecil</p>
                    </div>
                    <div>
                        <p class="text-black font-semibold">123</p>
                        <p class="text-orange-500">Angka</p>
                    </div>
                    <div>
                        <p class="text-black font-semibold">@#$</p>
                        <p class="text-orange-500">Simbol</p>
                    </div>
                </div>
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <input type="password" name="password"
                                class="w-full border rounded-md p-3 pr-10 focus:ring-2 focus:ring-orange-400 focus:outline-none placeholder-gray-400"
