...
<body class="bg-orange-500">
    <div class="grid grid-cols-1 md:grid-cols-5 min-h-screen md:block lg:grid">
        ...
        <div class="col-span-3 flex justify-center items-center bg-orange-500 ">
            <div class="bg-white rounded-2xl w-10/12 py-5 px-8 md:w-full lg:w-9/12">
                <div class="w-full">
                    <h1 class="text-[#fa6601] font-bold text-2xl mb-3 text-center">Masuk</h1>
                    ...
                    <form class="bg" action="/masuk/finance" method="POST">
                        @csrf
                        ...
                        <div>
                            ...
                            <a href="/verifikasi/finance" class="float-right font-semibold text-[#fa6601] lg:px-4">Lupa
                                Kata
                                Sandi</a>
                        </div>
                        ...
                        <div class="flex justify-center mt-4">
                            <span class="font-semibold text-black">Tidak Memiliki Acount? <a href="/register/finance"
