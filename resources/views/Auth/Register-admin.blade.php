    ...
    <div class="grid grid-cols-1 md:grid-cols-5 min-h-screen">
        ...
        <div class="col-span-3 flex justify-center items-center bg-white">
            <div class="w-10/12 md:w-full px-8 lg:w-10/12">
                ...
                <div class="w-full">
                    <h1 class=" font-bold text-2xl mb-4 text-center">Buat Akun</h1>
                    ...
                    <form id="form-pelamar" action="/buat/admin" method="POST">
                        ...
                        <div class="flex items-center justify-center mb-4">
                            <label class="flex items-center text-gray-500 font-semibold">
                                ...
                                <span class="text-[12px] text-black">saya menyetujui <a class="text-[#616161]">syarat
                        ...
                        <div class="flex justify-center">
                            <button type="submit"
                                class="w-52 bg-[#616161] mt-3 py-4 rounded-full hover:opacity-80 hover:-translate-y-1 transition-all duration-500 text-white font-semibold">
                                DAFTAR
                            </button>
                        </div>
                    </form>
